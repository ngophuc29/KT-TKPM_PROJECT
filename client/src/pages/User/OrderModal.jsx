...
const ORDER_API_URL = `https://kt-tkpm-project-order-service.onrender.com/user/${fakeUserId}`;
...
export default function OrderModal({ show, onHide }) {
    ...
    const handleCancelOrder = async (orderId) => {
        ...
        try {
            const res = await fetch(`https://kt-tkpm-project-order-service.onrender.com/cancel/${orderId}`, {
                method: "POST",
            });
